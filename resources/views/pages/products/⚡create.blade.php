...
new #[Title('Create Product')] class extends Component
{
    ...
    public function create()
    {
        ...
        // image
        if ($this->image) {
            // File akan masuk ke storage/app/public/images/products
            // Link ke public/storage/images/products akan otomatis bekerja
            $validated['image'] = $this->image->store('images/products', 'public');
        }
        // buat slug otomatis ngambil name dan tambahkan angka yang unik
        $validated['slug'] = Str::slug($validated['name']) . '-' . Str::random(5);
        // Hapus titik agar menjadi angka murni (Integer)
...
<div class="space-y-4">
    ...
    <div class="lg:flex lg:items-center lg:justify-between">
        <h1 class="text-2xl font-bold tracking-tight mb-4 lg:mb-0">Create Product</h1>
    </div>
    <!-- Form -->
            ...
            <form wire:submit="create">
                <x-ui.fieldset>
                    ...
                    <div class="flex justify-end space-x-3 mt-8">
                        ...
                        <x-ui.button type="submit" class="w-full md:w-auto">Create Product</x-ui.button>
                    </div>
                </x-ui.fieldset>
            </form>
        </div>
            ...
            <div
                ...
                <div class="flex flex-col items-center justify-center w-full p-4">
                    ...
                    <button type="button" wire:click="$set('image', null)"
                        class="mt-2 text-xs text-red-600 hover:underline">Hapus Gambar</button>
                    @else
