...
new #[Title('Edit User')] class extends Component
{
    ...
    public function update()
    {
        ...
        if ($this->avatar && !is_string($this->avatar)) {
            ...
            // Jika tidak ada upload baru, gunakan avatar yang sudah ada
...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
            ...
            <!-- Container untuk preview avatar -->
            <div
                ...
                <div class="flex flex-col items-center justify-center w-full p-4">
                    ...
                    <!-- Tampilkan avatar lama jika belum ada upload baru -->
                    <img src="{{ asset('storage/' . $existingAvatar) }}"
                        class="rounded-lg object-cover w-full h-auto max-h-64 shadow-sm">
                    <p class="mt-2 text-xs text-gray-500">Avatar Saat Ini</p>
